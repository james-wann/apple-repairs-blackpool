...
symptom: MacBook is dead, no chime, no screen, no fan, no response to power button
summary: A MacBook that won't power on can be anything from a flat battery to a failed logic board. Most cases are recoverable. We diagnose at no fault-finding cost beyond the £75 diagnostic fee, which is deducted from any subsequent repair.
