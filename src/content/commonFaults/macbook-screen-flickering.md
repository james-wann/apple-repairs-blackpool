...
symptom: Screen flickers, flashes, or shows horizontal lines, sometimes worse when the lid is opened or closed to certain angles
summary: Screen flicker on a MacBook is most often a display cable that's frayed where it bends across the hinge. Less commonly, it's a failing display panel or a graphics chip fault. Cable replacements are quick and inexpensive; panel replacements cost more.
affects: [MacBook Pro]
order: 40
---
